...
impl TrustPolicy {
    ...
    /// Host-only trust: localhost or a trusted-CIDR member, the gate used for inbound timelord
    /// acceptance. Node-id trust deliberately does NOT apply — that gate keys on the source
