...
// RATE_LIMITS_V3 over the real WS loopback.
//
// The shape:
...
// RATE_LIMITER ban. The loopback peer's recorded host is swapped to a public address to step past
// the localhost bypass; the bypass itself is the second half of the test.
#[tokio::test]
...
// enforced, and the connection keeps serving.
#[tokio::test]
